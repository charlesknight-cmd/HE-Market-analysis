...
Since May I've been scraping every job advert on jobs.ac.uk, once a day. About 7,000 so far, and 62% of them are fixed-term.

That number is close to useless on its own, because it depends so much on the subject.

Biological sciences: 83% fixed-term. Maths, physical sciences and history: 80%. Business and management: 36%. Creative arts: 35%.
...
History and philosophy doesn't fit that. It advertises research and lecturer posts in roughly equal numbers and still sits at 80% fixed-term, the same as physics. There's no grant-funding explanation for that one. It's teaching on temporary contracts.
...
7,000 UK university job adverts since May. 62% fixed-term overall, but that runs from 35% in creative arts to 83% in biological sciences, and the reason is mostly what each subject is hiring.

## Notes for you before posting

- Numbers are as of 2 September 2026 and will drift slightly with each daily scrape. Re-run the chart script on the day you post if you want them exact.
